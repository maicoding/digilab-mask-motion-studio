...
export const MASK_PRESETS = [
  {
    ...
    family: 'Form 01',
    format: 'square',
    maskSrc: './masks/Post_Form_01.png',
    width: 0.74,
    height: 0.74,
    stageY: 0.52,
    shapeScale: 0.92,
  ...
  },
  {
    ...
    family: 'Form 01',
    format: 'story',
    maskSrc: './masks/Story_Form_01.png',
    width: 0.76,
    height: 0.58,
    stageY: 0.54,
    shapeScale: 0.88,
  ...
  },
  {
    ...
    family: 'Form 02',
    format: 'square',
    maskSrc: './masks/Post_Form_02.png',
    width: 0.77,
    height: 0.77,
    stageY: 0.52,
    shapeScale: 1.0,
  ...
  },
  {
    ...
    family: 'Form 02',
    format: 'story',
    maskSrc: './masks/Story_Form_02.png',
    width: 0.76,
    height: 0.57,
    stageY: 0.55,
    shapeScale: 0.98,
  ...
  },
  {
    ...
    family: 'Form 03',
    format: 'square',
    maskSrc: './masks/Post_Form_03.png',
    width: 0.61,
    height: 0.73,
    stageY: 0.52,
    shapeScale: 0.86,
  ...
  },
  {
    ...
    family: 'Form 03',
    format: 'story',
    maskSrc: './masks/Story_Form_03.png',
    width: 0.55,
    height: 0.5,
    stageY: 0.56,
    shapeScale: 0.84,
  ...
  },
  {
    ...
    family: 'Form 04',
    format: 'square',
    maskSrc: './masks/Post_Form_04.png',
    width: 0.78,
    height: 0.78,
    stageY: 0.52,
    shapeScale: 1.04,
  ...
  },
  {
    ...
    family: 'Form 04',
    format: 'story',
    maskSrc: './masks/Story_Form_04.png',
    width: 0.79,
    height: 0.57,
    stageY: 0.55,
    shapeScale: 1.02,
...
export const FORM_MOTION_PRESETS = [
  ...
  { id: 'form05-original', label: 'Form 05 Original Content', maskPresetId: 'post-form-05', motionPresetId: 'soft-float', infoLayoutPresetId: 'editorial-content' },
  ...
  { id: 'story05-original', label: 'Story 05 Original Content', maskPresetId: 'story-form-05', motionPresetId: 'soft-float', infoLayoutPresetId: 'editorial-content' },
];

export const createInitialScene = () => ({
  presetId: 'square',
  colorPresetId: 'blau-weiss',
  ...
  infoLayer: {
    show: true,
    date: 'Dienstag\n04.06.2024',
    title1: 'Bilder erstellen',
    title2: 'mit KI',
    start: 'Start: 11:00',
    duration: 'Dauer: 1 Stunde',
    location: 'online',
    email: 'Anmeldung unter:\nai.digilab@fh-dortmund.de',
    titleColor: '#FFFFFF',
    metaColor: '#FFFFFF',
    emailColor: '#FFFFFF',
    dateColor: '#FFFFFF',
